...
use Lessphp\Formatter\LessJsFormatter;
use Lessphp\Parser\LesscParser;
...
class Lessc
{
    ...
    {
        $className = "Lessphp\Formatter\LessJsFormatter";
        if (!empty($this->formatterName)) {
            if (!is_string($this->formatterName))
                return $this->formatterName;
            $className = 'Lessphp\Formatter\\'.ucfirst($this->formatterName).'Formatter';
        }
